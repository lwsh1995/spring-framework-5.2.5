 ...
 *     overridden by infoBean configuration.
 -->
<#macro bind path>
 ...
 * formMultiSelect
 *
 * Show a listbox of options allowing the infoBean to make 0 or more choices from
 * the list of options.
 *
 * @param path the name of the field to bind to
 * @param options a map (value=label) of all the available options
 ...
 * This function is used internally but can be accessed by infoBean code if required.
 *
