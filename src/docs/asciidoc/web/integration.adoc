...
info interface framework. It is an official part of the Java EE umbrella but also
...
for the web info interface and the Spring container for the lower layers.
