...
* If the parameter names have been explicitly specified by the infoBean, the specified
...
conditions (idempotent operations that do not need to go back to the infoBean for conflict
