...
* If the parameter names have been explicitly specified by the info, the specified
...
conditions (idempotent operations that do not need to go back to the info for conflict
